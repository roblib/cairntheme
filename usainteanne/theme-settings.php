 ...
 *   A form array.
 */
function usainteanne_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = zen_theme_get_default_settings('usainteanne');
  ...
  $form['usainteanne_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use this sample setting'),
    '#default_value' => $settings['usainteanne_example'],
