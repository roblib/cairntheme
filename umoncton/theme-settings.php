 ...
 *   A form array.
 */
function umoncton_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = zen_theme_get_default_settings('umoncton');
  ...
  $form['umoncton_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use this sample setting'),
    '#default_value' => $settings['umoncton_example'],
